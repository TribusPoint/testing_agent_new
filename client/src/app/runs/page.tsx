          ...
          <div className="relative rounded-2xl border border-white/60 bg-white/70 p-8 shadow-xl shadow-indigo-500/10 ring-1 ring-indigo-500/5 backdrop-blur-xl dark:border-white/10 dark:bg-gray-900/75 dark:shadow-indigo-950/40 dark:ring-white/5">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                We&apos;re building a full run history here—live status, transcripts, scores, and exports. Soon you
                will be able to start runs from this screen and drill into every step your agents took.
              </p>
              ...
              <div className="mt-8 flex w-full max-w-xs flex-col gap-2">
                ...
                <p className="text-center text-[11px] text-gray-400 dark:text-gray-500">
                  Coming soon · run list, filters, and detail views in development
                </p>
              </div>
            </div>
          </div>
