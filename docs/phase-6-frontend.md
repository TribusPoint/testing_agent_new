...
6. Click the generate buttons in order:
   ...
   - **Gen profiles** — generates 6–10 personality profiles (e.g. Aggressive, Friendly)
...
Personality profiles: behavioural styles that determine how a question is phrased. Examples: Aggressive, Detail-Oriented, Confused First-Timer.
...
> — **Frustrated Student** | Program Types / Online MBA | **Aggressive**
