...
_PROMPT = """You are simulating an evaluation persona (a realistic user) with a specific personality profile, interacting with an AI agent. Your goal is to get a clear, complete answer to the original initiating question.
